 ...
 */
function bruteForceCanSumNumbersToTarget(targetSum, numbers) {
  if (targetSum === 0) return true
  if (targetSum < 0) return false

  for (let num of numbers) {
    const remainder = targetSum - num
    if (bruteForceCanSumNumbersToTarget(remainder, numbers) === true) {
      return true
    }
  }
  return false
...
module.exports.bruteForceCanSumNumbersToTarget = bruteForceCanSumNumbersToTarget
