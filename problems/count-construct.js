 ...
 */
function bruteForceWordsFromWordBankCount(targetWord, wordBank) {
  ...
  for (let word of wordBank) {
    if (targetWord.indexOf(word) === 0) {
      totalCount += bruteForceWordsFromWordBankCount(targetWord.substring(word.length), wordBank)
    }
  }
  return totalCount
}

module.exports.bruteForceWordsFromWordBankCount = bruteForceWordsFromWordBankCount;
